...
void YYPARSERNAME::yytables()
{
	...
	static const yystateaction_t YYNEARFAR YYBASED_CODE stateaction[] = {
		...
		{ 0, 0, YYAT_REDUCE, 22 },
		{ 0, 0, YYAT_DEFAULT, 154 },
		{ -180, 1, YYAT_REDUCE, 66 },
		{ 0, 0, YYAT_REDUCE, 18 },
		{ 0, 0, YYAT_REDUCE, 17 },
		{ -149, 1, YYAT_REDUCE, 78 },
		{ -170, 1, YYAT_REDUCE, 54 },
		{ -172, 1, YYAT_REDUCE, 72 },
		...
		{ 0, 0, YYAT_REDUCE, 70 },
		{ 0, 0, YYAT_REDUCE, 71 },
		{ -184, 1, YYAT_DEFAULT, 154 },
		{ 0, 0, YYAT_DEFAULT, 154 },
		{ 0, 0, YYAT_DEFAULT, 114 },
		{ 0, 0, YYAT_DEFAULT, 114 },
		{ -161, 1, YYAT_DEFAULT, 154 },
		{ 0, 0, YYAT_DEFAULT, 154 },
		{ 0, 0, YYAT_DEFAULT, 154 },
		{ 0, 0, YYAT_DEFAULT, 154 },
		{ 0, 0, YYAT_DEFAULT, 154 },
